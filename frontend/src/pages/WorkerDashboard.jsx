  ...
  return (
    <div className="space-y-10 py-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {bookings.length === 0 ? (
            ...
            <div className="space-y-4">
              {bookings.map(booking => (
                <div key={booking.id} className="glass rounded-xl p-5 border border-slate-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 hover:border-slate-700/80 transition duration-300">
        ...
        {/* Profile Details Settings & QR Mapping */}
        <div className="space-y-8">
          
          {/* Profile details */}
          <div className="glass p-6 rounded-2xl border border-slate-800 space-y-4">
            <h3 className="text-lg font-bold text-white">Gig Services Profile</h3>
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-4">
              ...
              <div>
                ...
                <input 
                  type="text"
                  placeholder="Maid, cooking, home cleaner"
                  value={skillsInput}
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-xl p-2.5 text-xs text-slate-200 focus:outline-none focus:border-purple-500 resize-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <input 
                    ...
                    className="w-1/2 bg-slate-900 border border-slate-800 rounded-xl p-2.5 text-xs text-slate-200 focus:outline-none"
                  />
                  <input 
                    type="text"
                    placeholder="Lng"
                ...
                <button 
                  ...
                  className="mt-2 text-[10px] text-purple-400 font-bold hover:underline"
                >
          ...
          {/* QR mapping card */}
          {profile?.qr_code && (
            <div className="glass p-6 rounded-2xl border border-slate-800 text-center space-y-4">
              ...
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 font-bold text-xs px-4 py-2 rounded-xl transition"
              >
                Open QR Image
              </a>
            </div>
          ...
          <div className="glass p-6 rounded-2xl border border-slate-800 space-y-4">
            ...
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {availabilities.length === 0 ? (
                ...
                availabilities.map(av => (
                  <div key={av.id} className="flex justify-between items-center bg-slate-900/60 p-2 rounded-lg text-xs border border-slate-800">
                    <div>
                    ...
                    <button onClick={() => handleDeleteSchedule(av.id)} className="text-rose-400 hover:text-rose-300">
            ...
            {/* Form */}
            <form onSubmit={handleAddSchedule} className="pt-2 border-t border-slate-800 space-y-3">
              <div>
