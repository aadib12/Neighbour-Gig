...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-neighbourgig-default-key-12345')
...
ROOT_URLCONF = 'neighbourgig.urls'
...
CORS_ALLOW_ALL_ORIGINS = True  # In production, specify CORS_ALLOWED_ORIGINS
